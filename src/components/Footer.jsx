...
export default function Footer() {
  ...
  className="bg-white p-2 rounded-full text-pink-600 hover:text-pink-700 transition-colors"
...
>
  <svg
    ...
    className="h-5 w-5"
    viewBox="0 0 448 512"
    fill="currentColor"   // 👈 text-pink-* se color milega
  >
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="bg-white p-2 rounded-full text-gray-900 hover:text-gray-700 transition-colors"
  aria-label="GitHub"
>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-5 w-5"
    viewBox="0 0 496 512"
    fill="currentColor"   // 👈 text-gray-* se color milega
  >
